// Bootstrap customizado do Vida Leve.
//
// Por que existe: o app é 100% online (Supabase, vídeos, Stripe). O service
// worker padrão do Flutter guardava tudo para uso offline — benefício zero
// aqui — e, a cada deploy, servia a versão velha em cache, causando tela
// branca em quem já tinha aberto o app antes (nem "atualizar" resolvia).
//
// Solução: NÃO registrar service worker (o loader roda sem serviceWorkerSettings)
// e, de quebra, remover qualquer service worker + cache que uma visita anterior
// tenha deixado — assim quem estava preso na versão velha se cura ao abrir esta.
...
(function () {
  ...
  } catch (e) { /* segue o jogo — a limpeza é best-effort */ }
})();
...
// Sem serviceWorkerSettings => nenhum service worker é registrado.
